...
export default function CE2Page() {
  ...
  const ce2Chapters = getChaptersByClass('CE2')
  const config = { color: '#4ecdc4', icon: '📖', name: 'CE2' }
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Découvrez les mathématiques du CE2</p>
                </div>
              </div>
            </div>
          </div>
