...
export default function SecondePage() {
  ...
  const secondeChapters = getChaptersByClass('2nde')
  const config = { color: '#00d2d3', icon: '🎯', name: '2nde' }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                  {config.icon}
                </div>
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">{config.name}</h1>
                  <p className="text-gray-600 mt-1">Découvrez les mathématiques de 2nde</p>
                </div>
              </div>
            </div>
          </div>
