...
export default function RepresenterNombresCE2Page() {
  ...
  const numbersToPlace = {
    '0-1000': [123, 250, 374, 480, 567, 600, 845, 912],
    '1000-2000': [1045, 1200, 1358, 1400, 1567, 1600, 1823, 1950],
    '2000-3000': [2134, 2300, 2456, 2500, 2678, 2700, 2845, 2901],
    '0-10000': [1234, 2500, 3678, 4800, 5923, 7100, 8456, 9012]
  };
