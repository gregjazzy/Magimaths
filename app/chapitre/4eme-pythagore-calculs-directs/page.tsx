...
export default function PythagoreCalculsDirectsPage() {
  ...
  const exercises = [
    ...
    // Exercices contraposée dans calculs directs
    {
      question: 'Triangle de côtés 4, 5 et 7. Peux-tu calculer l\'hypoténuse par Pythagore ?',
      answer: 'non',
      explanation: '4² + 5² = 16 + 25 = 41 ≠ 49 = 7². Par la contraposée, ce triangle n\'est pas rectangle, donc Pythagore ne s\'applique pas.',
      hint: 'Vérifie d\'abord si le triangle est rectangle'
    },
    {
      question: 'Côtés 6, 7 et 8. Peut-on utiliser a² + b² = c² ?',
      answer: 'non',
      explanation: '6² + 7² = 36 + 49 = 85 ≠ 64 = 8². Ce n\'est pas un triangle rectangle.',
      hint: 'La contraposée nous dit que ce n\'est pas rectangle'
    },
    {
      question: 'Triangle de côtés 1, 4 et 5. Rectangle ou pas ?',
      answer: 'non',
      explanation: '1² + 4² = 1 + 16 = 17 ≠ 25 = 5². Par contraposée : pas rectangle.',
      hint: 'Utilise la contraposée pour conclure rapidement'
    },
    {
      question: 'Côtés 3, 6 et 9. Pythagore s\'applique-t-il ?',
      answer: 'non',
      explanation: '3² + 6² = 9 + 36 = 45 ≠ 81 = 9². Triangle pas rectangle, donc Pythagore ne s\'applique pas.',
      hint: 'Pas rectangle = pas de Pythagore !'
    },
    {
      question: 'Triangle de côtés 2, 5 et 6. Contraposée applicable ?',
      answer: 'oui',
      explanation: '2² + 5² = 4 + 25 = 29 ≠ 36 = 6². La contraposée s\'applique : triangle pas rectangle.',
      hint: 'Si a² + b² ≠ c², alors contraposée applicable'
    }
  ]
