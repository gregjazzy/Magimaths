...
export default function RepresenterNombresCE1Page() {
  ...
  const numbersToPlace = {
    '0-100': [35, 47, 73, 83],
    '100-200': [125, 147, 163, 185],
    '200-300': [203, 235, 267, 285],
  ...
  const exercises = [
    ...
    { number: 143, range: '100-200', tolerance: 5 },
    { number: 426, range: '0-1000', tolerance: 25 },
    { number: 67, range: '0-100', tolerance: 5 },
    { number: 758, range: '0-1000', tolerance: 25 },
    { number: 185, range: '100-200', tolerance: 5 },
    { number: 839, range: '0-1000', tolerance: 25 },
    { number: 912, range: '0-1000', tolerance: 25 },
    { number: 739, range: '0-1000', tolerance: 25 },
    { number: 184, range: '100-200', tolerance: 5 },
    { number: 52, range: '0-100', tolerance: 5 },
    { number: 863, range: '0-1000', tolerance: 25 },
    { number: 267, range: '200-300', tolerance: 5 },
    { number: 91, range: '0-100', tolerance: 5 },
    { number: 694, range: '0-1000', tolerance: 25 },
    { number: 235, range: '200-300', tolerance: 5 },
    { number: 987, range: '0-1000', tolerance: 25 }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-4 sm:mb-8">
          <Link href="/chapitre/ce1-nombres-jusqu-1000" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors mb-2 sm:mb-4">
        ...
        {!showExercises ? (
          ...
          <div className="space-y-4 sm:space-y-8">
            ...
            <div id="number-line-demo" className={`bg-white rounded-xl p-4 sm:p-8 shadow-lg ${
              ...
              <div className="relative mb-8 sm:mb-16 mt-6 sm:mt-12">
                {/* Ligne principale */}
          ...
          <div className="space-y-4 sm:space-y-8">
            ...
            <div className="bg-white rounded-xl p-3 sm:p-6 md:p-8 shadow-lg overflow-visible">
                ...
                >
                  ...
                  {generateGraduations(exercises[currentExercise].range).map((value, index) => (
                    ...
                    >
                      ...
                      <div className="text-[10px] font-bold text-gray-700 mt-2 text-center min-w-max transform -translate-x-1/2">
                        {value}
                      </div>
                    </div>
                  ))}
              ...
              {/* Résultat */}
              {isCorrect !== null && (
                <div className={`p-2 sm:p-4 rounded-lg mb-16 sm:mb-24 mt-16 sm:mt-24 ${
              ...
              {/* Navigation */}
              <div className="flex justify-center space-x-2 sm:space-x-3 md:space-x-4 mt-24 sm:mt-32 md:mt-40">
                <button
                  onClick={() => setCurrentExercise(Math.max(0, currentExercise - 1))}
                  disabled={currentExercise === 0}
                  className="bg-gray-300 text-gray-700 px-3 sm:px-4 md:px-6 py-2 sm:py-2 md:py-3 rounded-lg font-bold hover:bg-gray-400 transition-colors disabled:opacity-50 text-xs sm:text-sm md:text-base min-h-[2.5rem] sm:min-h-[3rem]"
                >
