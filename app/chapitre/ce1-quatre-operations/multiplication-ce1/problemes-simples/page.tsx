...
export default function ProblemesMultiplication() {
  ...
  const problemExamples = [
    {
      id: 'chaussettes',
      title: 'Les paires de chaussettes',
      story: 'Léa a 3 paires de chaussettes. Combien de chaussettes a-t-elle en tout ?',
      first: 3,
      second: 2,
      result: 6,
      item: '🧦',
      ...
      operation: '3 × 2 = 6',
      explanation: 'Chaque paire = 2 chaussettes'
    },
    {
      id: 'roues',
      title: 'Les roues des vélos',
      story: 'Tom a 4 vélos. Combien de roues y a-t-il en tout ?',
      first: 4,
      second: 2,
      result: 8,
      item: '🚲',
      ...
      operation: '4 × 2 = 8',
      explanation: 'Chaque vélo = 2 roues'
    },
    {
      id: 'doigts',
      title: 'Les doigts des mains',
      story: 'Julie compte avec 3 mains. Combien de doigts utilise-t-elle ?',
      first: 3,
      second: 5,
      result: 15,
      item: '🖐️',
      ...
      operation: '3 × 5 = 15',
      explanation: 'Chaque main = 5 doigts'
    },
    {
      id: 'pieces',
      title: 'Les pièces de 10 centimes',
      story: 'Papa a 6 pièces de 10 centimes. Combien de centimes a-t-il ?',
      first: 6,
      second: 10,
      result: 60,
      item: '🪙',
      ...
      operation: '6 × 10 = 60',
      explanation: 'Chaque pièce = 10 centimes'
    },
    {
      id: 'pattes',
      title: 'Les pattes des chats',
      story: 'Dans la ferme, il y a 5 chats. Combien de pattes ont-ils en tout ?',
      first: 5,
      second: 4,
      result: 20,
      item: '🐱',
      ...
      operation: '5 × 4 = 20',
      explanation: 'Chaque chat = 4 pattes'
    },
    {
      id: 'yeux',
      title: 'Les yeux des poupées',
      story: 'Emma a 6 poupées. Combien d\'yeux ont-elles en tout ?',
      first: 6,
      second: 2,
      result: 12,
      item: '👁️',
      color1: 'text-blue-600',
      color2: 'text-brown-600',
      operation: '6 × 2 = 12',
      explanation: 'Chaque poupée = 2 yeux'
    },
    {
      id: 'orteils',
      title: 'Les orteils des pieds',
      story: 'Max compte les orteils de 4 pieds. Combien d\'orteils compte-t-il ?',
      first: 4,
      second: 5,
      result: 20,
      item: '🦶',
      ...
      color2: 'text-red-600',
      operation: '4 × 5 = 20',
      explanation: 'Chaque pied = 5 orteils'
    },
    {
      id: 'crayons',
      title: 'Les boîtes de crayons',
      story: 'Sophie a 8 boîtes de 10 crayons. Combien de crayons a-t-elle ?',
      first: 8,
      second: 10,
      result: 80,
      item: '🖍️',
      ...
      operation: '8 × 10 = 80',
      explanation: 'Chaque boîte = 10 crayons'
    },
    {
      id: 'oreilles',
      title: 'Les oreilles des lapins',
      story: 'Dans le jardin, il y a 7 lapins. Combien d\'oreilles ont-ils en tout ?',
      first: 7,
      second: 2,
      result: 14,
      item: '🐰',
      ...
      operation: '7 × 2 = 14',
      explanation: 'Chaque lapin = 2 oreilles'
    }
  ];

  // Exercices progressifs CE1 : problèmes de multiplication avec les tables de 2, 5 et 10
  const exercises = [
    // NIVEAU 1 : Table de 2 (paires, doubles)
    {
      story: 'Léo a 4 paires de chaussettes. Combien de chaussettes a-t-il en tout ?',
      question: 'Combien de chaussettes a-t-il en tout ?',
      answer: 8,
      visual: '🧦',
      first: 4,
      second: 2,
    ...
    {
      story: 'Emma a 3 vélos. Combien de roues y a-t-il en tout ?',
      question: 'Combien de roues y a-t-il en tout ?',
      answer: 6,
      visual: '🚲',
      first: 3,
      second: 2,
    ...
    {
      story: 'Tom a 5 paires de gants. Combien de gants a-t-il ?',
      question: 'Combien de gants a-t-il ?',
      answer: 10,
      visual: '🧤',
      first: 5,
      second: 2,
    ...
    // NIVEAU 2 : Table de 5 (mains, doigts)
    {
      story: 'Julie compte avec 2 mains. Combien de doigts utilise-t-elle ?',
      question: 'Combien de doigts utilise-t-elle ?',
      answer: 10,
      visual: '🖐️',
      first: 2,
      second: 5,
    ...
    {
      story: 'Max a 4 pièces de 5 centimes. Combien de centimes a-t-il ?',
      question: 'Combien de centimes a-t-il ?',
      answer: 20,
      visual: '🪙',
      first: 4,
      second: 5,
    ...
    {
      story: 'Léa a 3 étoiles à 5 branches. Combien de branches en tout ?',
      question: 'Combien de branches en tout ?',
      answer: 15,
      visual: '⭐',
      first: 3,
      second: 5,
    ...
    // NIVEAU 3 : Table de 10 (dizaines)
    {
      story: 'Papa a 3 billets de 10 euros. Combien d\'euros a-t-il ?',
      question: 'Combien d\'euros a-t-il ?',
      answer: 30,
      visual: '💶',
      first: 3,
      second: 10,
    ...
    {
      story: 'Sophie a 5 boîtes de 10 crayons. Combien de crayons a-t-elle ?',
      question: 'Combien de crayons a-t-elle ?',
      answer: 50,
      visual: '✏️',
      first: 5,
      second: 10,
    ...
    {
      story: 'Tom collectionne les cartes par paquets de 10. Il a 7 paquets. Combien de cartes a-t-il ?',
      question: 'Combien de cartes a-t-il ?',
      answer: 70,
      visual: '🎴',
      first: 7,
      second: 10,
    ...
    // NIVEAU 4 : Mélange des tables (révisions)
    {
      story: 'Dans la ferme, il y a 6 chats. Combien de pattes ont-ils en tout ?',
      question: 'Combien de pattes ont-ils en tout ?',
      answer: 24,
      visual: '🐱',
      first: 6,
      second: 4,
    ...
    {
      story: 'Maman achète 4 paquets de 5 bonbons. Combien de bonbons a-t-elle ?',
      question: 'Combien de bonbons a-t-elle ?',
      answer: 20,
      visual: '🍬',
      first: 4,
      second: 5,
    ...
    {
      story: 'Julie a 8 paires de boucles d\'oreilles. Combien de boucles a-t-elle ?',
      question: 'Combien de boucles a-t-elle ?',
      answer: 16,
      visual: '💎',
      first: 8,
      second: 2,
  ...
  const readIntroText = async () => {
    ...
    try {
      await playAudio("Qu'est-ce qu'un problème de multiplication ?");
      await wait(800);
      
      if (stopSignalRef.current) return;
      
      await playAudio("Un problème de multiplication raconte une histoire avec des groupes d'objets. Notre mission est de trouver combien d'objets il y a dans chaque groupe et combien de groupes pour calculer le total !");
      await wait(1000);
  ...
  const explainChapterWithSam = async () => {
    ...
    try {
      ...
      await playAudio("Salut, aventurier ! Bienvenue dans le monde des problèmes de multiplication !");
      if (stopSignalRef.current) return;
      
      await wait(1000);
      if (stopSignalRef.current) return;
      
      await playAudio("Aujourd'hui, tu vas apprendre à compter des groupes et multiplier comme un vrai explorateur !");
      if (stopSignalRef.current) return;
      ...
      await playAudio("D'abord, nous allons voir ce qu'est un problème de multiplication...");
      if (stopSignalRef.current) return;
    ...
    try {
      ...
      switch (step) {
        case 'step1':
          ...
          break;
        case 'step2':
          text = "Deuxième étape : Je trouve les deux nombres à multiplier. Je cherche dans l'histoire le nombre de groupes et combien d'objets dans chaque groupe.";
          break;
        case 'step3':
          text = "Troisième étape : J'écris la multiplication et je calcule. Je pose l'opération et je trouve le résultat pour répondre à la question.";
          break;
        default:
  ...
  const readSectionMethod = async () => {
    ...
    try {
      ...
      await playAudio("Ma méthode en 3 étapes pour résoudre un problème de multiplication.");
      if (stopSignalRef.current) return;
      ...
      await playAudio("Deuxième étape : je trouve les deux nombres à multiplier. Je cherche dans l'histoire le nombre de groupes et combien d'objets dans chaque groupe.");
      if (stopSignalRef.current) return;
      ...
      await playAudio("Troisième étape : j'écris la multiplication et je calcule le résultat. Je pose l'opération et je trouve le résultat pour répondre à la question.");
      if (stopSignalRef.current) return;
  ...
  const explainExercisesWithSam = async () => {
    ...
    try {
      ...
      await playAudio("Tu vas résoudre 15 problèmes de multiplication différents, c'est parti pour l'aventure !");
      if (stopSignalRef.current) return;
  ...
  const explainChapter = async () => {
    ...
    try {
      ...
      await playAudio("Bonjour ! Aujourd'hui, nous allons apprendre à résoudre des problèmes de multiplication. C'est très important de savoir transformer une histoire en calcul !");
      await wait(500);
      ...
      await playAudio("Pour résoudre un problème de multiplication, il faut suivre 3 étapes importantes :");
      await wait(300);
      ...
      // Étape 2
      setAnimatingStep('step2');
      await playAudio("Deuxième étape : je trouve les deux nombres à multiplier dans l'histoire.");
      await wait(500);
      ...
      // Étape 3
      setAnimatingStep('step3');
      await playAudio("Troisième étape : j'écris la multiplication et je calcule le résultat !");
      await wait(800);
  ...
  const explainSpecificExample = async (index: number) => {
    ...
    try {
      ...
      // Calcul - D'abord annoncer la multiplication
      setAnimatingStep('calculation');
      await playAudio(`Pour trouver le total, je fais la multiplication : ${example.first} fois ${example.second} égale ${example.result}.`);
      
      // MAINTENANT scroller vers la multiplication posée qui s'affiche
      scrollToElement('animation-section');
      await wait(800);
  ...
  const quickVocalCorrection = async () => {
    ...
    try {
      ...
      await quickAudio(`${first} fois ${second} égale ${result}`);
      
      // Scroll vers la zone d'animation de l'exercice pour voir la multiplication posée
  ...
  // Fonction officielle pour rendre une multiplication posée (adaptée du code CE1)
  const renderPostedMultiplication = (exampleData: any, isAnimated = false, showHelperBox = false, animationStep?: string) => {
    const example = {
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-800 mb-2">
              ✖️ Problèmes de multiplication
            </h1>
            <p className="text-lg text-gray-600 hidden sm:block">
              Apprendre à résoudre des problèmes de multiplication - Niveau CE1
            </p>
          </div>
        </div>
          ...
          <div className="space-y-2 sm:space-y-6">
            ...
            >
              <div className="flex items-center gap-1 sm:gap-3 mb-3 sm:mb-4">
                ...
                <h2 className="text-base sm:text-2xl font-bold text-gray-800">Qu'est-ce qu'un problème de multiplication ?</h2>
              ...
              <p className="text-sm sm:text-lg text-gray-700 leading-relaxed">
                Un problème de multiplication raconte une histoire avec des groupes d'objets. 
                Notre mission est de trouver combien d'objets il y a dans chaque groupe et combien de groupes pour calculer le total !
              </p>
            </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center gap-4 p-4 rounded-lg transition-all ${
                  ...
                  <p className="text-sm sm:text-lg text-gray-800">Je trouve les deux nombres à multiplier</p>
                </div>
                ...
                <div className={`flex items-center gap-4 p-4 rounded-lg transition-all ${
                  ...
                  <p className="text-sm sm:text-lg text-gray-800">J'écris la multiplication et je calcule</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-lg text-gray-700 p-3 bg-white rounded border">
                    {highlightNumbers("Marie a 4 paquets de 5 bonbons. Combien de bonbons a-t-elle en tout ?", highlightNumbersInStory)}
                  </div>
                </div>
              ...
              {currentExample !== null && (() => {
                ...
                return (
                    <div className="space-y-6">
                      ...
                      {/* Animation des objets ou multiplication posée */}
                      {example.first <= 9 && example.second <= 9 ? (
                        ...
                        // Multiplication posée avec fonction officielle - seulement aux bonnes étapes
                        (animatingStep === 'calculation' || animatingStep === 'result') && 
                        renderPostedMultiplication(example, true, false, animatingStep || undefined)
                      )}
              ...
              {!showCompletionModal ? (
                <div className="space-y-6">
                  ...
                  <div className="p-3 sm:p-4 bg-blue-50 rounded-lg">
                    <div className="text-sm sm:text-lg text-center text-gray-800 mb-3 sm:mb-4">{exercises[currentExercise].story}</div>
                    ...
                    <div className="text-center">
                      <button
                        ...
                        className={`px-3 sm:px-4 py-1 sm:py-2 bg-green-500 text-white rounded-lg text-sm sm:text-base font-semibold hover:bg-green-600 transition-all ${
                  ...
                  <div className="text-center space-y-4">
                    <input
                      ...
                      autoCapitalize="off"
                      spellCheck="false"
                      className={`text-center text-lg sm:text-xl font-bold border-2 border-gray-300 rounded-lg px-3 sm:px-4 py-1 sm:py-2 w-24 sm:w-32 transition-all ${
                    ...
                    <div>
                      <button
                        ...
                        onClick={checkAnswer}
                        disabled={!userAnswer}
                        className={`bg-blue-500 text-white px-4 sm:px-6 py-1 sm:py-2 rounded-lg text-sm sm:text-base font-semibold hover:bg-blue-600 disabled:opacity-50 transition-all ${
                  ...
                  {showExerciseAnimation && !isCorrect && (
                    <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6 mb-4">
                      <h3 className="text-base sm:text-lg font-bold text-center mb-3 sm:mb-4 text-yellow-800">
                          ...
                          <div className="space-y-4">
                            ...
                            {(exerciseAnimationStep === 'highlight-numbers' || exerciseAnimationStep === 'show-groups' || exerciseAnimationStep === 'show-calculation' || exerciseAnimationStep === 'show-result') && (
                              <div className="text-center p-3 bg-yellow-100 rounded-lg">
                                <p className="text-sm sm:text-lg text-yellow-800">
                            ...
                            {/* Animation des objets ou multiplication posée avec fonction officielle */}
                            {(exerciseAnimationStep === 'show-groups' || exerciseAnimationStep === 'show-calculation' || exerciseAnimationStep === 'show-result') && (
                              exercise.first <= 9 && exercise.second <= 9 ? (
                                ...
                                // Multiplication posée avec fonction officielle - correction exercices (seulement à partir du calcul)
                                (exerciseAnimationStep === 'show-calculation' || exerciseAnimationStep === 'show-result') &&
                                renderPostedMultiplication(exercise, true, false, exerciseAnimationStep || undefined)
                              )
                            )}
                  ...
                  {isCorrect !== null && (
                    <div 
                      ...
                      <div className="flex items-center justify-center gap-2 mb-2">
                        ...
                        <div className="text-xl sm:text-2xl">{exercises[currentExercise].visual}</div>
                      </div>
                      <div className="mb-3">
