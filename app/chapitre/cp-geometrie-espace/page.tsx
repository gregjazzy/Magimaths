      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6 px-2">
              Découvre les formes, l'espace et apprends à tracer avec précision !
            </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-lg">
                Formes géométriques, repérage dans l'espace, lignes et reproductions !
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <div className="bg-gradient-to-r from-indigo-400 to-purple-400 rounded-xl p-4 sm:p-6 text-white">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2">Bravo architecte de l'espace !</h3>
            <p className="text-sm sm:text-base lg:text-lg px-2">
              {completedSections.length === 0 && "Prêt à explorer les formes et l'espace ?"}
              {completedSections.length > 0 && completedSections.length < sections.length && "Continue, tu découvres les secrets de la géométrie !"}
              {completedSections.length === sections.length && "Félicitations ! Tu maîtrises la géométrie et l'espace !"}
            </p>
          </div>
        </div>
      </div>
