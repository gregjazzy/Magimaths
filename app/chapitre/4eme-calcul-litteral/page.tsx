      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="group relative bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20 hover:border-white/40 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 overflow-hidden">
            ...
            <div 
              className="absolute top-0 left-0 right-0 h-1 transition-all duration-500 group-hover:h-2"
              style={{ background: `linear-gradient(90deg, #ff6b6b, #ff6b6bAA, #ff6b6b80)` }}
            />
            ...
            <div className="relative z-10">
              <div className="flex items-center space-x-4 mb-4">
                <div 
                  className="w-12 h-12 rounded-2xl flex items-center justify-center text-white font-bold text-lg shadow-xl transform group-hover:scale-125 group-hover:rotate-6 transition-all duration-300"
                  style={{ background: `linear-gradient(135deg, #ff6b6b, #ff6b6bAA, #ff6b6b80)` }}
                >
                  🧮
                </div>
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-gray-900 group-hover:text-red-600 transition-colors">Problèmes</h3>
                  <div className="flex items-center gap-2 mt-1">
              ...
              <Link
                href={`/chapitre/4eme-calcul-litteral-problemes`}
                className={`w-full bg-gradient-to-r text-white py-3 px-4 rounded-xl font-bold text-center inline-block hover:opacity-90 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl`}
                style={{ background: `linear-gradient(90deg, #ff6b6b, #ff6b6bCC)` }}
              >
                <Play className="inline w-4 h-4 mr-2" />
                Commencer
              </Link>
