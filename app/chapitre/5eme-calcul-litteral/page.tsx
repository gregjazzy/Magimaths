    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mt-4 text-center">
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Découvrez le calcul littéral ! Apprenez à manipuler les expressions avec des lettres, 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Autres chapitres */}
          {subChapters.filter(chapter => chapter.id !== '5eme-calcul-litteral-expressions').map((chapter) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  ...
                  className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 px-4 rounded-lg font-medium text-center inline-block hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-md flex items-center justify-center space-x-2"
                >
        ...
        <div className="mt-12 bg-white rounded-xl p-8 shadow-lg border border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">🎯 Objectifs du calcul littéral</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Remplacer les variables par des valeurs
              </p>
            </div>
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-500">
            <p>© 2024 Mathématiques 5ème - Calcul littéral interactif</p>
          </div>
        </div>
      </footer>
    </div>
