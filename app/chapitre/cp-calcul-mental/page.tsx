  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-blue-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-16 w-32 h-32 bg-cyan-300/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-64 right-24 w-40 h-40 bg-blue-300/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-32 left-32 w-24 h-24 bg-purple-300/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-64 right-16 w-36 h-36 bg-pink-300/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '3s'}}></div>
      </div>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-4xl font-bold text-cyan-800 flex items-center">
                <span className="mr-3 text-3xl sm:text-5xl animate-bounce">🧠</span>
                Calcul mental
              </h1>
