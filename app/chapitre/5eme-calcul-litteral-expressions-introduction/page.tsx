        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-purple-100">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800 mb-2">Introduction - Expressions littérales</h1>
              ...
              <div className="ml-auto text-right">
                ...
                <div className="text-xl font-semibold text-purple-600">8 minutes</div>
              </div>
            </div>
