...
export default function AdditionSansRetenueCE2() {
  ...
  const additionExamples = [
    ...
    { num1: 23, num2: 31, num3: 42, result: 96, hasCarry: false, description: '3 nombres à 2 chiffres sans retenue' },
    { num1: 231, num2: 324, num3: 143, result: 698, hasCarry: false, description: '3 nombres à 3 chiffres sans retenue' },
    { num1: 321, num2: 142, num3: 36, result: 499, hasCarry: false, description: '2 nombres à 3 chiffres + 1 nombre à 2 chiffres' }
  ];
  ...
  const baseExercises = [
    ...
    // 3. Addition de 3 nombres à 2 chiffres
    { 
      question: 'Pour additionner 3 nombres, combien de signes + ?', 
      correctAnswer: '2 signes +',
      choices: ['1 signe +', '2 signes +', '3 signes +']
    },
    { 
      question: 'Calcule : 13 + 42 + 24', 
      correctAnswer: '79',
      choices: ['69', '79', '89'],
      visual: '   13\n+  42\n+  24\n─────\n   ?'
    },
    { 
      question: 'Calcule : 31 + 24 + 13', 
      correctAnswer: '68',
      choices: ['68', '58', '78'],
      visual: '   31\n+  24\n+  13\n─────\n   ?'
    },
    
    // 4. Addition de 3 nombres à 3 chiffres
    { 
      question: 'Calcule : 112 + 243 + 134', 
      correctAnswer: '489',
      choices: ['489', '479', '499'],
      visual: '  112\n+ 243\n+ 134\n─────\n   ?'
    },
    { 
      question: 'Calcule : 121 + 235 + 143', 
      correctAnswer: '499',
      choices: ['499', '489', '509'],
      visual: '  121\n+ 235\n+ 143\n─────\n   ?'
    },
    ...
    { 
      question: 'Calcule : 123 + 245 + 31', 
      correctAnswer: '399',
      choices: ['399', '389', '409'],
      visual: '  123\n+ 245\n+  31\n─────\n   ?'
    },
    { 
      question: 'Calcule : 213 + 152 + 24', 
      correctAnswer: '389',
      choices: ['389', '379', '399'],
      visual: '  213\n+ 152\n+  24\n─────\n   ?'
    },
  ...
  const explainExample = async (index: number) => {
    ...
    try {
      ...
      await playAudio(`Maintenant, la colonne des unités devient bleue ! Regarde bien... Je calcule : ${num1Units} plus ${num2Units}${example.num3 ? ` plus ${num3Units}` : ''} égale ${unitsSum} !`, true);
      if (stopSignalRef.current) return;
      ...
      if (maxDigits >= 2) {
        ...
        await wait(1000);
        const tensSum = num1Tens + num2Tens + (example.num3 ? num3Tens : 0) + carry;
        if (example.hasCarry) {
          await playAudio(`Je calcule : ${num1Tens} plus ${num2Tens}${example.num3 ? ` plus ${num3Tens}` : ''}... plus ${carry} de retenue ! Ça fait ${tensSum} !`, true);
        } else {
          await playAudio(`Je calcule : ${num1Tens} plus ${num2Tens}${example.num3 ? ` plus ${num3Tens}` : ''}... égale ${tensSum} !`, true);
        }
        if (stopSignalRef.current) return;
      ...
      if (maxDigits >= 3) {
        ...
        await wait(1000);
        const hundredsSum = num1Hundreds + num2Hundreds + (example.num3 ? num3Hundreds : 0);
        await playAudio(`Je calcule : ${num1Hundreds} plus ${num2Hundreds}${example.num3 ? ` plus ${num3Hundreds}` : ''}... égale ${hundredsSum} !`, true);
        if (stopSignalRef.current) return;
