      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-3 sm:p-6 mb-4 sm:mb-8 border-2 border-orange-200">
          <div className="flex items-center gap-2 sm:gap-4 mb-3 sm:mb-4">
            <Link href="/chapitre/ce2-operations-complexes/addition-ce2/calcul-mental" className="bg-orange-100 hover:bg-orange-200 p-2 sm:p-3 rounded-lg transition-colors">
              <ArrowLeft className="w-4 h-4 sm:w-6 sm:h-6 text-orange-600" />
            </Link>
            <div>
              <h1 className="text-lg sm:text-3xl font-bold text-gray-900">
                🧮 Calcul mental jusqu'à 1000 - CE2
              </h1>
