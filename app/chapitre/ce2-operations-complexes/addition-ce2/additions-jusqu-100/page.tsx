...
const ExerciceSection = dynamic(() => import('./components/ExerciceSection'), {
  loading: () => <div>Chargement des exercices...</div>,
  ssr: false
});

const CoursSection = dynamic(() => import('./components/CoursSection'), {
  loading: () => <div>Chargement du cours...</div>,
  ssr: false
});

export default function AdditionsJusqua100CE2() {
