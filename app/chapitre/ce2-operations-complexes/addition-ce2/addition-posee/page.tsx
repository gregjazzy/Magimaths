...
export default function AdditionPoseeCE2() {
  ...
  // Exemples d'additions posées - COURS UNIQUEMENT sans retenue - ADAPTÉS POUR CE2
  const additionExamples = [
    // Exemples 1-3 : nombres à 3 chiffres sans retenue
    { num1: 123, num2: 145, result: 268, hasCarry: false, description: 'nombres à 3 chiffres sans retenue' },
    { num1: 241, num2: 132, result: 373, hasCarry: false, description: 'nombres à 3 chiffres sans retenue' },
    { num1: 312, num2: 124, result: 436, hasCarry: false, description: 'nombres à 3 chiffres sans retenue' },
    
    // Exemple 4 : un nombre à 3 chiffres + un nombre à 4 chiffres sans retenue
    { num1: 234, num2: 1123, result: 1357, hasCarry: false, description: '3 chiffres + 4 chiffres sans retenue' },
    
    // Exemples 5+ : nombres à 4 chiffres sans retenue
    { num1: 1234, num2: 2143, result: 3377, hasCarry: false, description: 'nombres à 4 chiffres sans retenue' },
    { num1: 2123, num2: 1234, result: 3357, hasCarry: false, description: 'nombres à 4 chiffres sans retenue' },
    { num1: 3124, num2: 2143, result: 5267, hasCarry: false, description: 'nombres à 4 chiffres sans retenue' }
  ];
  ...
  const baseExercises = [
    // 1. Introduction addition posée
    {
      question: 'Comment aligne-t-on les nombres dans une addition posée ?', 
      correctAnswer: 'Unités sous unités, dizaines sous dizaines',
      choices: ['N\'importe comment', 'Unités sous unités, dizaines sous dizaines', 'De gauche à droite']
    },
    
    // 2. Démarrage avec calculs simples sans retenues - ADAPTÉS POUR CE2
    { 
    ...
    { 
      question: 'Calcule : 241 + 132', 
      correctAnswer: '373',
      choices: ['371', '373', '375'],
      visual: '  241\n+ 132\n─────\n   ?'
    },
    
    // 3. Concept de l'addition posée
    { 
      question: 'Par quelle colonne commence-t-on une addition posée ?', 
      correctAnswer: 'Par les unités (à droite)',
      choices: ['Par les centaines', 'Par les unités (à droite)', 'Par les dizaines']
    },
    { 
      question: 'Calcule : 312 + 124', 
      correctAnswer: '436',
      choices: ['434', '436', '438'],
      visual: '  312\n+ 124\n─────\n   ?'
    },
    { 
      question: 'Calcule : 421 + 143', 
      correctAnswer: '564',
      choices: ['562', '564', '566'],
      visual: '  421\n+ 143\n─────\n   ?'
    },
    { 
      question: 'Calcule : 234 + 132', 
      correctAnswer: '366',
      choices: ['364', '366', '368'],
      visual: '  234\n+ 132\n─────\n   ?'
    },
    
    // 4. Additions avec nombres plus grands sans retenues - ADAPTÉS POUR CE2
    { 
      question: 'Calcule : 1234 + 2143', 
      correctAnswer: '3377',
      choices: ['3375', '3377', '3379'],
      visual: ' 1234\n+2143\n─────\n   ?'
    },
    { 
      question: 'Calcule : 2123 + 1234', 
      correctAnswer: '3357',
      choices: ['3355', '3357', '3359'],
      visual: ' 2123\n+1234\n─────\n   ?'
    },
    { 
      question: 'Calcule : 3124 + 2143', 
      correctAnswer: '5267',
      choices: ['5265', '5267', '5269'],
      visual: ' 3124\n+2143\n─────\n   ?'
    },
    { 
      question: 'Calcule : 1432 + 1234', 
      correctAnswer: '2666',
      choices: ['2664', '2666', '2668'],
      visual: ' 1432\n+1234\n─────\n   ?'
    },
    { 
      question: 'Calcule : 2341 + 1423', 
      correctAnswer: '3764',
      choices: ['3762', '3764', '3766'],
      visual: ' 2341\n+1423\n─────\n   ?'
    },
    { 
      question: 'Calcule : 1324 + 2143', 
      correctAnswer: '3467',
      choices: ['3465', '3467', '3469'],
      visual: ' 1324\n+2143\n─────\n   ?'
    },
    
    // 5. Exercices complexes sans retenues - ADAPTÉS POUR CE2
    { 
      question: 'Calcule : 2134 + 1432', 
      correctAnswer: '3566',
      choices: ['3564', '3566', '3568'],
      visual: ' 2134\n+1432\n─────\n   ?'
    },
    { 
      question: 'Calcule : 3241 + 1324', 
      correctAnswer: '4565',
      choices: ['4563', '4565', '4567'],
      visual: ' 3241\n+1324\n─────\n   ?'
    },
    { 
      question: 'Pourquoi aligne-t-on les chiffres par colonnes ?', 
      correctAnswer: 'Pour additionner les unités avec les unités',
      choices: ['Pour faire joli', 'Pour additionner les unités avec les unités', 'Pour aller plus vite']
    },
    
    // 6. Défis finaux sans retenues - ADAPTÉS POUR CE2
    { 
      question: 'Calcule : 4321 + 1234', 
      correctAnswer: '5555',
      choices: ['5553', '5555', '5557'],
      visual: ' 4321\n+1234\n─────\n   ?'
    },
    { 
      question: 'L\'addition posée nous aide à...', 
      correctAnswer: 'Calculer des gros nombres facilement',
      choices: ['Aller plus vite', 'Faire plus joli', 'Calculer des gros nombres facilement']
    }
  ];
      ...
      {/* Header */}
        <div className="mb-6 sm:mb-8">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-200 rounded-xl p-4 sm:p-6 shadow-lg text-center">
                ...
                📝 Addition posée sans retenue - CE2
            </h1>
        </div>
      </div>
            ...
            >
              <div className="text-center mb-3 sm:mb-6">
                ...
                <p className="text-xs sm:text-base text-gray-600">
                  Nous apprenons les additions posées avec des nombres plus grands, sans retenues !
                </p>
            </div>
