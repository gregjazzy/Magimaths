...
export default function CE2OperationsComplexes() {
  ...
  const sections = [
    {
      id: 'addition-ce2',
      title: 'Addition',
      description: 'Maîtriser l\'addition avec des nombres plus grands et techniques avancées',
      icon: '➕',
      duration: '20 min',
      xp: 25,
    ...
    },
    {
      id: 'soustraction-ce2',
      title: 'Soustraction',
      description: 'Maîtriser la soustraction avec retenue et nombres plus complexes',
      icon: '➖',
      duration: '20 min',
      xp: 25,
    ...
    {
      id: 'multiplication-ce2',
      title: 'Multiplication',
      description: 'Multiplication posée et tables de multiplication avancées',
      icon: '✖️',
      duration: '25 min',
      xp: 30,
    ...
    },
    {
      id: 'division-ce2',
      title: 'Division',
      description: 'Découverte de la division euclidienne et partage équitable',
      icon: '➗',
      duration: '25 min',
      xp: 30,
  ...
  useEffect(() => {
    const savedProgress = localStorage.getItem('ce2-operations-complexes-progress');
    if (savedProgress) {
  ...
  const getSectionPath = (sectionId: string) => {
    return `/chapitre/ce2-operations-complexes/${sectionId}`;
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              🔢 Opérations complexes - CE2
            </h1>
            <p className="text-lg text-gray-600 mb-6">
              Maîtrise les quatre opérations avec des techniques avancées et des nombres plus grands !
            </p>
        ...
        <div className="bg-gradient-to-r from-teal-400 to-cyan-500 rounded-xl p-6 mb-8 text-white">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div>
              ...
              <p className="text-lg">
                À la fin de ce chapitre, tu maîtriseras les 4 opérations et tu sauras faire des calculs complexes !
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="bg-gradient-to-r from-teal-400 to-cyan-400 rounded-xl p-6 text-white">
            ...
            <h3 className="text-xl font-bold mb-2">Bravo super calculateur !</h3>
            <p className="text-lg">
              {completedSections.length === 0 && "Commence ton aventure avec les opérations complexes !"}
              {completedSections.length > 0 && completedSections.length < sections.length && "Continue, tu deviens un expert en calcul !"}
