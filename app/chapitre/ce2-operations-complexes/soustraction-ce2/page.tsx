...
export default function CE2SoustractionPage() {
  const config = { color: '#ef4444', icon: '➖', name: 'Soustraction CE2' };
  ...
  const subChapters = [
    {
      ...
      estimatedTime: 20,
      difficulty: 'Débutant',
      href: '/chapitre/ce2-operations-complexes/soustraction-ce2/soustractions-10'
    },
    {
      ...
      href: '/chapitre/ce2-operations-complexes/soustraction-ce2/soustractions-100'
    },
    {
      ...
      estimatedTime: 25,
      difficulty: 'Intermédiaire',
      href: '/chapitre/ce2-operations-complexes/soustraction-ce2/soustraction-posee'
    },
    {
      ...
      estimatedTime: 30,
      difficulty: 'Intermédiaire',
      href: '/chapitre/ce2-operations-complexes/soustraction-ce2/soustraction-retenue'
    },
    {
      id: 'complements-soustraction',
      title: 'Compléments et soustraction',
      description: 'Découvre les liens entre addition et soustraction !',
      icon: '🔗',
      estimatedTime: 20,
      difficulty: 'Intermédiaire',
      href: '/chapitre/ce2-operations-complexes/soustraction-ce2/complements-soustraction'
    },
    {
      ...
      estimatedTime: 25,
      difficulty: 'Avancé',
      href: '/chapitre/ce2-operations-complexes/soustraction-ce2/problemes-soustraction'
    }
  ];
        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-lg text-gray-600">
              Maîtrise la soustraction avec des nombres plus grands et des techniques avancées !
            </p>
          </div>
        </div>
