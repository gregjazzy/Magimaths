...
export default function SoustractionRetenueCE2() {
  ...
  // Exemples de soustractions posées avec retenue (3-4 chiffres pour CE2)
  const subtractionExamples = [
    { num1: 352, num2: 127, result: 225, hasBorrow: true, description: 'soustraction à 3 chiffres avec retenue' },
    { num1: 481, num2: 245, result: 236, hasBorrow: true, description: 'soustraction à 3 chiffres avec retenue' },
    { num1: 573, num2: 238, result: 335, hasBorrow: true, description: 'soustraction à 3 chiffres avec retenue' },
    { num1: 691, num2: 367, result: 324, hasBorrow: true, description: 'soustraction à 3 chiffres avec retenue' },
    { num1: 1284, num2: 756, result: 528, hasBorrow: true, description: 'soustraction à 4 chiffres avec retenue' },
    { num1: 1571, num2: 834, result: 737, hasBorrow: true, description: 'soustraction à 4 chiffres avec retenue' },
    { num1: 2162, num2: 948, result: 1214, hasBorrow: true, description: 'soustraction à 4 chiffres avec retenue' }
  ];
  ...
  const baseExercises = [
    ...
    // 2. Démarrage avec calculs à 3 chiffres avec retenues - CE2
    { 
      question: 'Calcule : 352 - 127', 
      correctAnswer: '225',
      choices: ['223', '225', '227'],
      visual: '  352\n- 127\n─────\n   ?'
    },
    { 
      question: 'Calcule : 481 - 245', 
      correctAnswer: '236',
      choices: ['234', '236', '238'],
      visual: '  481\n- 245\n─────\n   ?'
    },
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50">
      ...
      {/* Header */}
        <div className="mb-6 sm:mb-8">
          <Link href="/chapitre/ce2-operations-complexes/soustraction-ce2" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors mb-3 sm:mb-4">
            <ArrowLeft className="w-4 h-4" />
            <span className="text-sm sm:text-base">Retour à la soustraction CE2</span>
            </Link>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-200 rounded-xl p-4 sm:p-6 shadow-lg text-center">
            <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold text-red-900 mb-3">
              ➖ Soustraction avec retenue - CE2 (3-4 chiffres)
            </h1>
        </div>
      </div>
