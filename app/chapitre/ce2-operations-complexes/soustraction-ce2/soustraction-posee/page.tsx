...
export default function SoustractionPoseeCE2() {
  ...
  // Exemples de soustractions posées CE2 (3-4 chiffres sans retenue)
  const subtractionExamples = [
    { num1: 437, num2: 214, result: 223, hasBorrow: false, description: 'soustraction à 3 chiffres sans retenue' },
    { num1: 577, num2: 235, result: 342, hasBorrow: false, description: 'soustraction à 3 chiffres sans retenue' },
    { num1: 689, num2: 326, result: 363, hasBorrow: false, description: 'soustraction à 3 chiffres sans retenue' },
    { num1: 1486, num2: 352, result: 1134, hasBorrow: false, description: 'soustraction à 4 chiffres sans retenue' },
    { num1: 1795, num2: 634, result: 1161, hasBorrow: false, description: 'soustraction à 4 chiffres sans retenue' },
    { num1: 2378, num2: 1241, result: 1137, hasBorrow: false, description: 'soustraction à 4 chiffres sans retenue' },
    { num1: 1968, num2: 845, result: 1123, hasBorrow: false, description: 'soustraction à 4 chiffres sans retenue' }
  ];
