        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg text-center">
            ...
            <p className="text-lg text-gray-600">
              Deviens un maître du calcul mental avec ces super astuces !
            </p>
          </div>
        </div>
                ...
                <div className="bg-white rounded-xl p-8 shadow-lg">
                  ...
                  <div className="text-center mb-6">
                    <input
                      ...
                      placeholder="?"
                      className="w-32 h-16 text-center text-2xl font-bold border-2 border-gray-300 rounded-lg focus:border-indigo-500 focus:outline-none"
                    />
                  </div>
                  ...
                  <div className="flex justify-center space-x-4 mb-6">
                    <button
                      ...
                      className="bg-indigo-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-indigo-600 transition-colors disabled:opacity-50"
                    >
