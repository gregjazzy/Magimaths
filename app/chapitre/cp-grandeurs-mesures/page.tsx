  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-yellow-50">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6 px-2">
              Découvre les longueurs, masses, contenances, le temps et la monnaie !
            </p>
        ...
        <div className="bg-gradient-to-r from-green-400 to-yellow-500 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 text-white">
          <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-lg">
                Comparer longueurs, masses, contenances, comprendre le temps et la monnaie !
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 sm:mt-8 bg-white rounded-xl p-4 sm:p-6 shadow-lg">
          ...
          <div className="mt-4">
            <div className="bg-gray-200 rounded-full h-3">
              <div 
                className="bg-gradient-to-r from-green-400 to-yellow-500 h-3 rounded-full transition-all duration-500"
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <div className="bg-gradient-to-r from-green-400 to-yellow-400 rounded-xl p-4 sm:p-6 text-white">
            <div className="text-3xl sm:text-4xl mb-3">🌟</div>
            <h3 className="text-lg sm:text-xl font-bold mb-2">Bravo petit mesureur !</h3>
            <p className="text-sm sm:text-base lg:text-lg px-2">
              {completedSections.length === 0 && "Prêt à explorer le monde des mesures ?"}
              {completedSections.length > 0 && completedSections.length < sections.length && "Continue, tu découvres les secrets des grandeurs !"}
