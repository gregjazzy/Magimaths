  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6 px-2">
              Apprends à additionner ! Découvre comment assembler des nombres pour en faire de plus grands.
            </p>
        ...
        <div className="bg-gradient-to-r from-orange-400 to-pink-500 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 text-white">
          <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-lg">
                Comprendre l'addition, calculer dans la limite de 100, résoudre des problèmes !
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <div className="bg-gradient-to-r from-orange-400 to-pink-400 rounded-xl p-4 sm:p-6 text-white">
