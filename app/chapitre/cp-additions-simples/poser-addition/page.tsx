...
export default function PoserAdditionCP() {
  ...
  // Exemples d'additions posées - SEULEMENT nombres à 2 chiffres pour CP
  const additionExamples = [
    ...
    { num1: 31, num2: 27, result: 58, hasCarry: false, description: 'sans retenue' },
    { num1: 64, num2: 25, result: 89, hasCarry: false, description: 'sans retenue' }
  ];

  // Exercices progressifs - ADAPTÉS POUR CP avec calculs variés
  const baseExercises = [
    ...
    // 3. Calculs variés à 2 chiffres - DIFFÉRENTS du cours
    { 
      question: 'Calcule : 32 + 15', 
      correctAnswer: '47',
      choices: ['46', '47', '48'],
      visual: '   32\n+  15\n─────\n   ?'
    },
    { 
      question: 'Calcule : 21 + 34', 
      correctAnswer: '55',
      choices: ['54', '55', '56'],
      visual: '   21\n+  34\n─────\n   ?'
    },
    { 
      question: 'Calcule : 43 + 16', 
      correctAnswer: '59',
      choices: ['58', '59', '60'],
      visual: '   43\n+  16\n─────\n   ?'
    },
    { 
      question: 'Calcule : 25 + 32', 
      correctAnswer: '57',
      choices: ['56', '57', '58'],
      visual: '   25\n+  32\n─────\n   ?'
    },
    { 
      question: 'Calcule : 17 + 41', 
      correctAnswer: '58',
      choices: ['57', '58', '59'],
      visual: '   17\n+  41\n─────\n   ?'
    },
    { 
      question: 'Calcule : 54 + 13', 
      correctAnswer: '67',
      choices: ['66', '67', '68'],
      visual: '   54\n+  13\n─────\n   ?'
    },
    { 
      question: 'Calcule : 18 + 31', 
      correctAnswer: '49',
      choices: ['48', '49', '50'],
      visual: '   18\n+  31\n─────\n   ?'
    },
    { 
      question: 'Calcule : 46 + 22', 
      correctAnswer: '68',
      choices: ['67', '68', '69'],
      visual: '   46\n+  22\n─────\n   ?'
    },
    { 
      question: 'Calcule : 35 + 24', 
      correctAnswer: '59',
      choices: ['58', '59', '60'],
      visual: '   35\n+  24\n─────\n   ?'
    },
  ...
  const explainChapterWithSam = async () => {
    ...
    try {
      // Introduction générale pour CP
      await playAudio("Salut ! Moi c'est Sam ! Aujourd'hui, on va apprendre l'addition posée ensemble ! C'est facile !", true);
      if (stopSignalRef.current) return;
      await wait(1000);
      
      await playAudio("En CP, on apprend à poser des petites additions avec des nombres à 2 chiffres ! C'est amusant !", true);
      if (stopSignalRef.current) return;
      await wait(1000);
      ...
      await playAudio("D'abord, nous allons comprendre ce que signifie 'poser une addition' ! C'est simple !", true);
      if (stopSignalRef.current) return;
      await wait(1000);
      ...
      await playAudio("Ensuite, voici l'exemple principal avec son animation ! Tu vas voir comme c'est facile !", true);
      if (stopSignalRef.current) return;
      await wait(1000);
      ...
      await playAudio("Ici, tu trouveras plein d'autres exemples à explorer ! Tous avec des nombres à 2 chiffres !", true);
      if (stopSignalRef.current) return;
      await wait(1000);
  ...
  const explainExample = async (index: number) => {
    ...
    try {
      ...
      await wait(1000);
      await playAudio("Souviens-toi : toujours commencer par les unités... puis les dizaines ! C'est facile !", true);
      if (stopSignalRef.current) return;
  ...
  // Fonction pour rendre une addition posée avec animations améliorées - ADAPTÉE POUR 2 CHIFFRES
  const renderPostedAddition = (example: any, isAnimated = false) => {
    // Pour CP, toujours 2 chiffres maximum
    const maxDigits = 2;
    ...
    // Séparer les chiffres (unités, dizaines)
      ...
      <div className={`bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl shadow-lg border-2 transition-all duration-500 ${
        ...
        <div className="flex justify-center">
          <div className="space-y-4">
            {/* Tableau des colonnes D et U seulement */}
            <div className="flex justify-center mb-4">
              <div className="grid gap-6 font-bold text-base grid-cols-2">
            ...
            {/* Premier nombre */}
            <div className="flex justify-center">
              <div className="grid gap-6 font-mono text-2xl grid-cols-2">
            ...
            <div className="flex justify-center">
              ...
              }`} style={{ width: '7.5rem' }}></div>
            </div>
            
            {/* Résultat avec animations progressives */}
            <div className="flex justify-center">
              <div className="grid gap-6 font-mono text-3xl font-bold grid-cols-2">
      ...
      {/* Header */}
        <div className="mb-6 sm:mb-8">
          <Link href="/chapitre/cp-additions-simples" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors mb-3 sm:mb-4">
            ...
            <span className="text-sm sm:text-base">Retour aux additions simples</span>
            </Link>
        ...
        {!showExercises ? (
          ...
          <div className="space-y-8">
                    ...
                    {calculationStep && (
                      <div className="bg-white rounded-lg p-4 shadow-inner">
                        <div className="text-lg font-semibold text-green-700">
                          ...
                          {calculationStep === 'result' && '4️⃣ Voici le résultat final ! Tu as réussi !'}
                      </div>
                    </div>
                  )}
                </div>
            ...
            <div className="bg-gradient-to-r from-green-400 to-teal-500 rounded-xl p-3 sm:p-6 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-4 text-center">
                <div>
