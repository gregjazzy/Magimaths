...
export default function CE2ComparaisonFractionsPage() {
  ...
  const explainChapter = async () => {
    ...
    if (!showExercises) {
      ...
      await playAudio("Ici tu vois les fractions à comparer. Utilise les symboles < = > pour donner ta réponse !");
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-100">
      ...
      {/* Header */}
        ...
        <div className="space-y-4 sm:space-y-8">
          {!showExercises ? <ComparaisonSection /> : <ExerciceSection />}
        </div>
      </div>
    </div>
  );
