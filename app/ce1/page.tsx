...
export default function CE1Page() {
  ...
  const ce1Chapters = getChaptersByClass('CE1')
  const config = { color: '#ff6b6b', icon: '📚', name: 'CE1' }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-pink-500 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                  {config.icon}
                </div>
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">{config.name}</h1>
                  <p className="text-gray-600 mt-1">Découvrez les mathématiques du CE1</p>
                </div>
              </div>
            </div>
          </div>
