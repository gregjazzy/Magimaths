    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-pink-500 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                  🎒
                </div>
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">CP</h1>
                  <p className="text-gray-600 mt-1">Découvrez les mathématiques du CP</p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          {/* Navigation des niveaux version mobile */}
          <div className="flex sm:hidden flex-wrap justify-center gap-3 mt-8">
            <Link 
              href="/ce1" 
              className="px-4 py-2 bg-white border-2 border-orange-200 text-orange-700 rounded-lg hover:bg-orange-50 transition-colors text-sm font-medium"
            >
