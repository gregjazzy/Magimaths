...
interface ChapterCardSquareProps {
  config: {
    id: string;
    title: string;
    description: string;
...
export default function ChapterCardSquare({ config, transparencyLevel = 5 }: ChapterCardSquareProps) {
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          {/* Header avec personnage et statut */}
          <div className="flex items-center justify-between mb-3">
            {config.character && (
              <div className="relative">
                <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${colors.characterBg} p-0.5 shadow-md`}>
                  {!imageError ? (
                    <img
          ...
          <div className="flex-1 mb-3">
            <h3 className={`font-bold ${colors.textColor} text-sm leading-tight mb-1`}>
              {config.title}
            </h3>
          ...
          <div className="flex items-center justify-between text-xs text-gray-600">
            <span>{formatNumber(xpData.xp)} XP</span>
