...
interface ChapterCardCompactHorizontalProps {
  config: {
    id: string;
    title: string;
    description: string;
...
export default function ChapterCardCompactHorizontal({ config, transparencyLevel = 4 }: ChapterCardCompactHorizontalProps) {
  ...
  return (
    ...
    >
      <div 
        className={`
          relative bg-gradient-to-r ${colors.bgGradient} rounded-xl shadow-md border border-white/50 p-4 h-28
      ...
      >
        ...
        {/* Layout compact pour 2 par ligne */}
        <div className="relative z-10 flex items-center h-full gap-4">
          
          {/* Personnage à gauche - Plus petit */}
          {config.character && (
