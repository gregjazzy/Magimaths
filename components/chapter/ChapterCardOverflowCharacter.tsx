...
export default function ChapterCardOverflowCharacter({ config, transparencyLevel = 4 }: ChapterCardOverflowCharacterProps) {
  ...
  return (
    <div className="relative">
      {/* Personnage qui déborde à gauche */}
      {config.character && (
      ...
      {/* Carte principale avec marge à gauche pour le personnage */}
      <Link 
      ...
      >
        ...
        >
          ...
          {/* Contenu avec padding à gauche pour décaler le texte plus à droite */}
          <div className="relative z-10 flex flex-col justify-between h-full p-4 pl-16">
            ...
            <div>
              ...
              {/* Infos détaillées - Plus d'espace horizontal */}
